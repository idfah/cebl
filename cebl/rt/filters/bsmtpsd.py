...
BiosemiMTPSDName = 'BioSemiMTPSD'


class BiosemiMTPSDConfigPanel(FilterConfigPanel):
...
class BiosemiMTPSD(Filter):
    def __init__(self, *args, **kwargs):
        Filter.__init__(self, *args, name=BiosemiMTPSDName,
                        configPanelClass=BiosemiMTPSDConfigPanel, **kwargs)
